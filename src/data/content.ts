...
export const teamMembers: TeamMember[] = [
  ...
  { name: 'Filippo Ingoglia', role: 'Driver', platforms: ['iRacing, LMU'], flag: 'it' },
  { name: 'Gosha Vershinin', role: 'Driver', platforms: ['LMU'], flag: 'ru' },
  ...
  { name: 'Mark Kerkhoff', role: 'Driver', platforms: ['ACC, LMU'], flag: 'nl' },
